class NexusMode{constructor(e){this.app=e,this.root=null,this.allPhrasals=[],this.allVerbs=new Set,this.allParticles=new Set,this.constellations=[],this.queue=[],this.current=null,this.score=0,this.combo=0,this.locked=!1,this.mode=null,this._netRaf=null,this.cipherVerbs=[],this.cipherParticles=[],this.cipherVerbIdx=0,this.cipherParticleIdx=0,this.synthSelected={verb:null,particle:null,verbId:null,particleId:null},this.synthHintTimer=null,this._loadData(),this._resizeHandler=()=>{this.mode==="network"&&this.current&&this._positionNodes()},window.addEventListener("resize",this._resizeHandler)}_loadData(){let e={},t=new Set,s=new Set;if(typeof PHRASE_DICT!="undefined"){for(const[i,r]of Object.entries(PHRASE_DICT))if(r.type==="Phrasal Verb"){const n=i.split(" "),a=n[0],l=n.slice(1).join(" ");t.add(a),s.add(l);let c={phrase:i,verb:a,particle:l,tr:r.tr,ex:r.ex};this.allPhrasals.push(c),e[a]||(e[a]=[]),e[a].push(c)}}this.allVerbs=Array.from(t),this.allParticles=Array.from(s),this.constellations=Object.keys(e).filter(i=>e[i].length>=2).map(i=>{let r=e[i];return r.length>5&&(r.sort(()=>.5-Math.random()),r=r.slice(0,5)),{verb:i,tasks:r}})}init(e){this.root=e,this._showIntro(),window._nexusDelegateAttached||(window._nexusDelegateAttached=!0,document.addEventListener("click",t=>{if(!window.nexusMod)return;if(t.target.closest(".nexus-start-network-btn")){window.nexusMod.startNetwork();return}if(t.target.closest(".nexus-start-cipher-btn")){window.nexusMod.startCipher();return}if(t.target.closest(".nexus-start-synthesis-btn")){window.nexusMod.startSynthesis();return}const s=t.target.closest(".nexus-clear-slot-btn");if(s){window.nexusMod.clearSynthSlot(s.dataset.slotType);return}const i=t.target.closest(".nexus-select-orb-btn");if(i){window.nexusMod.selectSynthOrb(i.dataset.orbType,i.dataset.orbWord,i.dataset.orbId);return}const r=t.target.closest(".nexus-core-speak-btn");if(r){window.nexusMod.playVerbAudio(r.dataset.verb);return}const n=t.target.closest(".nexus-particle-answer-btn");if(n){window.nexusMod.checkNetworkAnswer(n.dataset.particle,n);return}const a=t.target.closest(".nexus-scroll-dial-btn");if(a){window.nexusMod.scrollDial(a.dataset.dialType,parseInt(a.dataset.dialDir));return}if(t.target.closest(".nexus-check-cipher-btn")){window.nexusMod.checkCipher();return}if(t.target.closest(".nexus-restart-btn")){window.nexusMod.init(window.nexusMod.root);return}}))}destroy(){window.removeEventListener("resize",this._resizeHandler),this._clearSynthTimer(),this._stopNetCanvas(),this.root&&(this.root.innerHTML="")}_clearSynthTimer(){this.synthHintTimer&&(clearTimeout(this.synthHintTimer),this.synthHintTimer=null)}_showIntro(){this.root.innerHTML=`
    ...
    `,this._createStars(30)}selectSynthOrb(e,t,s,i=!1){if(this.locked||this.synthSelected[e]!==null)return;!i&&e==="verb"&&this._clearSynthTimer(),this.app.audio&&this.app.audio.play("tick"),this.synthSelected[e]=t,this.synthSelected[e+"Id"]=s;const r=document.getElementById(s);r&&r.classList.add("used");const n=document.getElementById(`slot-${e}`);n&&(n.innerText=t,n.classList.add("filled",e)),this.synthSelected.verb&&this.synthSelected.particle&&(this.locked=!0,this._clearSynthTimer(),setTimeout(()=>this.checkSynthesis(),400))}clearSynthSlot(e){if(this.locked||!this.synthSelected[e])return;this.app.audio&&this.app.audio.play("pop");const t=this.synthSelected[e+"Id"],s=document.getElementById(t);s&&s.classList.remove("used"),this.synthSelected[e]=null,this.synthSelected[e+"Id"]=null;const i=document.getElementById(`slot-${e}`);i&&(i.innerText=e==="verb"?"F\u0130\u0130L":"EDAT",i.classList.remove("filled",e))}checkSynthesis(){var e,t;const s=this.synthSelected.verb===this.current.verb,i=this.synthSelected.particle===this.current.particle,r=document.getElementById("slot-verb"),n=document.getElementById("slot-particle"),a=document.getElementById("synth-reactor");if(s&&i){this.app.audio&&this.app.audio.play("correct"),r&&r.classList.add("success"),n&&n.classList.add("success"),a&&(a.style.borderColor="#10b981",a.style.background="radial-gradient(circle, rgba(16, 185, 129, 0.2) 0%, transparent 80%)");const l=document.getElementById("synth-sentence");if(l){l.textContent="";const o=document.createTextNode('"'+this.current.ex+'"');l.appendChild(o);const d=document.createElement("div");d.style.cssText="color:#ec4899; margin-top:20px; font-size:1.5rem; font-weight:800; letter-spacing:3px;",d.textContent="F\xDCZYON BA\u015EARILI!",l.appendChild(d),l.style.color="#10b981"}this.app.speakWord&&this.app.speakWord(this.current.ex);const c=(t=(e=window.remoteFlags)==null?void 0:e.xp_nexus_base)!=null?t:15;this.score+=c*3+this.combo*10,this.combo++,this._updateHUD(),setTimeout(()=>{this.currentIndex++,this.nextSynthesisWord()},3500)}else this.app.audio&&this.app.audio.play("error"),r&&r.classList.add("error"),n&&n.classList.add("error"),this.combo=0,this._updateHUD(),setTimeout(()=>{if(r&&r.classList.remove("error"),n&&n.classList.remove("error"),this.synthSelected.verbId){const l=document.getElementById(this.synthSelected.verbId);l&&l.classList.remove("used")}if(this.synthSelected.particleId){const l=document.getElementById(this.synthSelected.particleId);l&&l.classList.remove("used")}this.synthSelected={verb:null,particle:null,verbId:null,particleId:null},r&&(r.innerText="F\u0130\u0130L",r.classList.remove("filled","verb")),n&&(n.innerText="EDAT",n.classList.remove("filled","particle")),this.locked=!1},800)}startNetwork(){this.mode="network";const e=[...this.constellations].sort(()=>.5-Math.random());if(this.queue=e.slice(0,5),this.queue.length===0){typeof UI!="undefined"&&UI.toast&&UI.toast("Tak\u0131my\u0131ld\u0131z\u0131 olu\u015Fturacak yeterli kelime bulunamad\u0131!");return}this.score=0,this.combo=0,this.currentIndex=0,this.nextNetworkWord()}nextNetworkWord(){if(this.currentIndex>=this.queue.length){this._showResults("A\u011F B\xFCt\xFCnle\u015Ftirildi");return}this.current=this.queue[this.currentIndex],this.locked=!1,this._renderNetwork()}_renderNetwork(){this.currentTasks=[...this.current.tasks].sort(()=>.5-Math.random()),this.currentTaskIndex=0;let e=this.currentTasks.map(s=>s.particle),t=this.allParticles.filter(s=>!e.includes(s));t.sort(()=>.5-Math.random()),e=[...e,...t.slice(0,3)],e.sort(()=>.5-Math.random()),this.root.innerHTML=`
      ...
      <div class="nexus-game-area" id="nexus-board">
        ...
        ${e.map((s,i)=>{const r=s.length<=4?"0.95rem":s.length<=7?"0.78rem":"0.65rem";return`<div class="nexus-particle-node nexus-particle-answer-btn" id="particle-${i}" style="font-size:${r}" data-particle="${s.replace(/"/g,"&quot;")}">${s}</div>`}).join("")}
      </div>
      ...
      <div class="nexus-bg-stars" id="nexus-stars"></div>
    `,setTimeout(()=>this._positionNodes(),30),this._createStars(40),this.app.audio&&this.app.audio.play("pop")}_positionNodes(){const e=document.getElementById("nexus-board"),t=document.getElementById("nexus-core");if(!e||!t)return;const s=e.getBoundingClientRect(),i=s.width/2,r=s.height/2,n=window.innerWidth<=480?74:90,a=n/2+12,l=Math.max(r,a+Math.min(s.width,s.height)*.38);t.style.left=`${i-t.offsetWidth/2}px`,t.style.top=`${l-t.offsetHeight/2}px`;const c=document.querySelectorAll(".nexus-particle-node"),o=n/2,d=i-o-4,u=Math.min(s.width,s.height)*.38,x=Math.max(u,window.innerWidth<600?100:150),h=Math.min(x,l-a,d);c.forEach((p,m)=>{const v=m/c.length*Math.PI*2-Math.PI/2,b=i+Math.cos(v)*h-p.offsetWidth/2,y=l+Math.sin(v)*h-p.offsetHeight/2;p.style.left=`${b}px`,p.style.top=`${y}px`,setTimeout(()=>p.classList.add("appeared"),80+m*80)}),this._redrawLines(),this._startNetCanvas()}_redrawLines(e=null){const t=document.getElementById("nexus-core"),s=document.getElementById("nexus-svg");if(!t||!s)return;s.innerHTML="";const i=t.getBoundingClientRect(),r=document.getElementById("nexus-board").getBoundingClientRect(),n=i.left+i.width/2-r.left,a=i.top+i.height/2-r.top;document.querySelectorAll(".nexus-particle-node").forEach(l=>{const c=l.getBoundingClientRect(),o=c.left+c.width/2-r.left,d=c.top+c.height/2-r.top,u=l.classList.contains("solved"),x=u&&l===e,h=document.createElementNS("http://www.w3.org/2000/svg","path");if(x){h.setAttribute("d",`M ${o} ${d} L ${n} ${a}`);const p=Math.round(Math.sqrt((o-n)**2+(d-a)**2));h.style.setProperty("--line-len",p),h.setAttribute("class","nexus-line snap-line")}else u?(h.setAttribute("d",`M ${n} ${a} L ${o} ${d}`),h.setAttribute("class","nexus-line correct-line")):(h.setAttribute("d",`M ${n} ${a} L ${o} ${d}`),h.setAttribute("class","nexus-line ambient-line"));s.appendChild(h)})}_drawLineTo(e){this._redrawLines(e)}checkNetworkAnswer(e,t){var s,i;if(this.locked||t.classList.contains("solved"))return;const r=this.currentTasks[this.currentTaskIndex];if(e===r.particle){this.locked=!0,t.classList.add("solved"),this._drawLineTo(t);const n=document.getElementById("nexus-core");n&&(n.classList.add("just-solved"),setTimeout(()=>n.classList.remove("just-solved"),900)),this.app.audio&&this.app.audio.play("correct"),this.app.speakWord&&this.app.speakWord(r.phrase);const a=(i=(s=window.remoteFlags)==null?void 0:s.xp_nexus_base)!=null?i:15;this.score+=a*2+this.combo*5,this.combo++,this._updateHUD();const l=document.getElementById("nx-q"),c=document.getElementById("nx-feedback");l&&(l.style.display="none"),c&&(c.style.display="flex",document.getElementById("nx-phrase-res").innerText=r.phrase,document.getElementById("nx-ex-res").innerText=`"${r.ex}"`),this.currentTaskIndex++,setTimeout(()=>{if(this.currentTaskIndex>=this.currentTasks.length)this._completeConstellation();else{l&&(l.style.display="block",l.innerText=this.currentTasks[this.currentTaskIndex].tr),c&&(c.style.display="none");const o=document.querySelector(".nexus-task-progress");o&&(o.innerText=`D\xFC\u011F\xFCm ${this.currentTaskIndex+1} / ${this.currentTasks.length}`),this.locked=!1}},2500)}else t.classList.add("wrong"),this.app.audio&&this.app.audio.play("error"),this.combo=0,this._updateHUD(),setTimeout(()=>{t.classList.remove("wrong")},800)}_completeConstellation(){var e,t;this.app.audio&&this.app.audio.play("level_up");const s=document.getElementById("nexus-core");if(s&&s.classList.add("constellation-complete-glow"),document.querySelectorAll(".correct-line, .snap-line").forEach(a=>a.classList.add("pulse-line")),s){const a=s.getBoundingClientRect(),l=a.left+a.width/2,c=a.top+a.height/2;document.querySelectorAll(".nexus-particle-node:not(.solved)").forEach((o,d)=>{const u=o.getBoundingClientRect(),x=l-(u.left+u.width/2),h=c-(u.top+u.height/2);o.style.transition=`transform 0.55s ${.08*d}s cubic-bezier(0.4,0,0.2,1), opacity 0.45s ${.08*d+.1}s ease`,o.style.transform=`translate(${x}px, ${h}px) scale(0)`,o.style.opacity="0",o.style.pointerEvents="none"})}const i=(t=(e=window.remoteFlags)==null?void 0:e.xp_nexus_base)!=null?t:15;this.score+=i*7,this._updateHUD();const r=document.getElementById("nx-q"),n=document.getElementById("nx-feedback");r&&(r.style.display="none"),n&&(n.style.display="flex",n.innerHTML=`
    ...
    `,this._createStars(40)}scrollDial(e,t){if(!this.locked)if(this.app.audio&&this.app.audio.play("tick"),e==="verb"){this.cipherVerbIdx+=t,this.cipherVerbIdx<0&&(this.cipherVerbIdx=this.cipherVerbs.length-1),this.cipherVerbIdx>=this.cipherVerbs.length&&(this.cipherVerbIdx=0);const s=document.getElementById("cipher-w-verb");s.innerText=this.cipherVerbs[this.cipherVerbIdx],s.classList.add("glow"),setTimeout(()=>s.classList.remove("glow"),200)}else{this.cipherParticleIdx+=t,this.cipherParticleIdx<0&&(this.cipherParticleIdx=this.cipherParticles.length-1),this.cipherParticleIdx>=this.cipherParticles.length&&(this.cipherParticleIdx=0);const s=document.getElementById("cipher-w-particle");s.innerText=this.cipherParticles[this.cipherParticleIdx],s.classList.add("glow"),setTimeout(()=>s.classList.remove("glow"),200)}}checkCipher(){var e,t;if(this.locked)return;const s=this.cipherVerbs[this.cipherVerbIdx],i=this.cipherParticles[this.cipherParticleIdx],r=s===this.current.verb,n=i===this.current.particle,a=document.getElementById("cipher-w-verb"),l=document.getElementById("cipher-w-particle");if(r&&n){this.locked=!0,this.app.audio&&this.app.audio.play("correct"),a.classList.add("correct"),l.classList.add("correct");const c=document.getElementById("cipher-sentence");c.textContent="";const o=document.createTextNode('"'+this.current.ex+'"');c.appendChild(o);const d=document.createElement("div");d.style.cssText="color:#10b981; margin-top:15px; font-size:1.3rem; font-weight:800; text-transform:uppercase; letter-spacing:2px;",d.textContent="\u{1F510} \u015E\u0130FRE KIRILDI!",c.appendChild(d),c.style.borderColor="#10b981",c.style.background="rgba(16, 185, 129, 0.15)",c.style.transform="scale(1.05)",this.app.speakWord&&this.app.speakWord(this.current.ex);const u=(t=(e=window.remoteFlags)==null?void 0:e.xp_nexus_base)!=null?t:15;this.score+=u*2+this.combo*5,this.combo++,this._updateHUD(),setTimeout(()=>{this.currentIndex++,this.nextCipherWord()},3500)}else this.app.audio&&this.app.audio.play("error"),r||(a.classList.add("wrong"),setTimeout(()=>a.classList.remove("wrong"),500)),n||(l.classList.add("wrong"),setTimeout(()=>l.classList.remove("wrong"),500)),this.combo=0,this._updateHUD()}playVerbAudio(e){this.app.speakWord&&this.app.speakWord(e);const t=document.getElementById("nexus-core");t&&(t.classList.add("active"),setTimeout(()=>t.classList.remove("active"),300))}_updateHUD(){const e=document.getElementById("nx-score"),t=document.getElementById("nx-combo");e&&(e.innerText=this.score),t&&(t.innerText=this.combo)}_showResults(e){var t,s,i;const r=(s=(t=window.remoteFlags)==null?void 0:t.multiplier_medium)!=null?s:1.5,n=Math.round(this.score*r);this.app.addXP&&this.score>0&&this.app.addXP(this.score,"medium","nexus"),(i=window.analyticsManager)==null||i.lessonComplete("nexus",this.score),this.root.innerHTML=`
      ...
      <div class="nexus-game-area" style="text-align:center;">
        ...
        <p style="color:var(--text-2); font-size:1.2rem; margin-bottom:30px;">Kazan\u0131lan Toplam XP: <strong style="color:var(--cyan)">+${n}</strong></p>
