    ...
    get annotations() {
      return ann(this._text, [
        ...
        { surface: "who was very kind", pos: "CLAUSE", type: "relative_clause", lemma: null,
          ...
          expl: "'who' burada öğretmeni niteleyen bir sıfat cümleciği başlatır. 'çok nazik olan öğretmen' anlamını verir.",
        ...
        { surface: "came over", pos: "VERB", type: "phrasal_verb", lemma: "come over",
          tr: "yanına geldi",
          expl: "'come over' = birisinin bulunduğu yere doğru gelmek, yanına geçmek.",
    ...
    get annotations() {
      return ann(this._text, [
        ...
        { surface: "looked out of the window", pos: "VERB", type: "phrasal_verb", lemma: "look out of",
          ...
          expl: "'look out of' = bir açıklıktan dışarıya bakmak. Burada pencerenin dışını seyretmek.",
        ...
        { surface: "made herself a cup of tea", pos: "VERB", type: "grammar_structure", lemma: null,
          ...
          expl: "Reflexive yapı + dative: 'herself' eylemi kendi için yaptığını gösterir. 'a cup of tea' standart içecek ifadesi.",
        ...
        { surface: "picked up", pos: "VERB", type: "phrasal_verb", lemma: "pick up",
          tr: "aldı / elinden tuttu / yerden kaldırdı",
        ...
        { surface: "who lived alone in a lighthouse", pos: "CLAUSE", type: "relative_clause", lemma: null,
          ...
          expl: "'who' kız hakkında ek bilgi verir. Tam yapı: 'yalnız başına bir fenerde yaşayan kız'.",
        ...
        { surface: "put her book down", pos: "VERB", type: "phrasal_verb", lemma: "put down",
          ...
          expl: "Split phrasal verb: 'put ... down' = elindeki nesneyi bırakmak. Burada nesne aradaki konuma girmiş.",
        ...
        { surface: "wash the dishes", pos: "VERB", type: "collocation", lemma: "wash",
          ...
          expl: "Yerleşik Türkçeye de geçmiş standart ifade. 'do the dishes' ile eş anlamlıdır.",
    ...
    get annotations() {
      return ann(this._text, [
        ...
        { surface: "looked back", pos: "VERB", type: "phrasal_verb", lemma: "look back",
          tr: "arkasına baktı / geriye döndü",
        ...
        { surface: "kept going", pos: "VERB", type: "grammar_structure", lemma: "keep going",
          ...
          expl: "'keep going' = durmayarak devam etmek. Burada düşmeden bisiklet sürmeye devam etmeyi ifade eder.",
        ...
        { surface: "making mistakes is part of learning", pos: "VERB", type: "grammar_structure", lemma: null,
          ...
          expl: "Gerund'ün özne olarak kullanımı: 'making mistakes' cümlenin öznesidir. İngilizcede fiil mastar olarak da özne olabilir.",
    ...
    get annotations() {
      return ann(this._text, [
        ...
        { surface: "could not believe her eyes", pos: "VERB", type: "idiom", lemma: null,
          ...
          expl: "Deyim. Beklenmedik bir şey karşısında çok şaşırmak; göreni hayrete düşüren bir durumu ifade eder.",
        ...
        { surface: "had been travelling", pos: "VERB", type: "grammar_structure", lemma: "travel",
          ...
          expl: "Past Perfect Continuous: geçmişte belirli bir noktadan önce başlayıp süren eylem. Vurgu devam üstünde.",
        ...
        { surface: "had completely forgotten about work", pos: "VERB", type: "grammar_structure", lemma: "forget",
          ...
          expl: "Past Perfect: fark etme anından önce unutmanın gerçekleştiğini gösterir. 'completely' yoğunlaştırıcı.",
        ...
        { surface: "in the end", pos: "ADV", type: "idiom", lemma: null,
          ...
          expl: "'in the end' = sonuç olarak, her şey bittiğinde. 'at the end' ile karıştırılmamalı.",
    ...
    get annotations() {
      return ann(this._text, [
        { surface: "make up his mind", pos: "VERB", type: "idiom", lemma: "make up one's mind",
          ...
          expl: "Deyim. Uzun süre düşündükten sonra bir karara ulaşmak. 'decide' den daha çok kararsızlık sürecini vurgular.",
        ...
        { surface: "paid much better than", pos: "VERB", type: "grammar_structure", lemma: "pay",
          ...
          expl: "Comparative + 'much' güçlendirici. 'paid' burada ücret anlamıyla geçmiş zamanda kullanılmış.",
        ...
        { surface: "who understood how difficult the decision was", pos: "CLAUSE", type: "relative_clause", lemma: null,
          ...
          expl: "'who' eşini niteleyen relative clause açar. 'how difficult' dolaylı soru yapısıdır.",
        ...
        { surface: "admitted that", pos: "VERB", type: "word", lemma: "admit",
          ...
          expl: "'admit' = hoş olmayan bir gerçeği kabullenmek ya da söylemek. Burada zorluğu dile getirmek.",
        ...
        { surface: "let fear stop him from moving forward", pos: "VERB", type: "grammar_structure", lemma: null,
          ...
          expl: "'let + nesne + bare infinitive + from + gerund': birinin bir şeyi yapmasına izin vermek yapısı.",
        ...
        { surface: "looking forward to making new friends", pos: "VERB", type: "phrasal_verb", lemma: "look forward to",
          ...
          expl: "'look forward to + gerund': heyecanla, sabırsızlıkla beklemek. 'to'dan sonra fiil -ing alır.",
    ...
    get annotations() {
      return ann(this._text, [
        { surface: "start from scratch", pos: "VERB", type: "idiom", lemma: "start from scratch",
          ...
          expl: "Deyim. Daha önce hiç yapılmamış gibi, temel bilgi ya da malzeme olmaksızın başlamak.",
        ...
        { surface: "looked simple enough", pos: "VERB", type: "grammar_structure", lemma: "look",
          ...
          expl: "'look + adjective' = görünmek, -gibi görünmek. 'enough' sıfat sonrasında 'yeterince' anlamı katar.",
        ...
        { surface: "a handful of fresh herbs", pos: "NOUN", type: "noun_phrase", lemma: null,
          tr: "bir avuç taze ot",
          expl: "'a handful of' = bir avuç kadar miktar ifadesi. Belirsiz ama somut miktar belirter.",
        ...
        { surface: "started to simmer", pos: "VERB", type: "word", lemma: "simmer",
          ...
          expl: "'simmer' = sıvının tam kaynamadan hafifçe fokurdaması. Mutfakta sık kullanılan teknik terim.",
        ...
        { surface: "filled with a wonderful smell", pos: "VERB", type: "grammar_structure", lemma: "fill",
          ...
          expl: "'fill with' = bir şeyle dolmak. Pasif benzeri yapı; mutfak kendiliğinden dolmuş.",
        ...
        { surface: "a willingness to make mistakes", pos: "NOUN", type: "noun_phrase", lemma: null,
          ...
          expl: "'willingness to + infinitive' = bir şeyi yapmaya istekli olma hâli. İsim tamlaması olarak işlev görür.",
  ...
  // ─── ORTA 4 ─────────────────────────────────────────────────
  {
    ...
    get annotations() {
      return ann(this._text, [
        ...
        { surface: "staring out of the window", pos: "VERB", type: "phrasal_verb", lemma: "stare out of",
          tr: "pencereden dışarıyı bakakalmak / dalmak",
          expl: "'stare' = dalmış gibi sabit bakmak. 'out of the window' bakış yönünü gösterir.",
          ex_en: "He sat staring out of the window for hours.", ex_tr: "Saatlerce pencereden dışarıyı bakakaldı." },
        { surface: "come into view", pos: "VERB", type: "phrasal_verb", lemma: "come into view",
          tr: "gözükmeye başlamak / görüş alanına girmek",
          expl: "'come into view' = uzaktan yavaş yavaş görünür hâle gelmek.",
          ex_en: "The mountains came into view as we drove north.", ex_tr: "Kuzeye sürerken dağlar yavaş yavaş göründü." },
        ...
        { surface: "the tension he had been carrying for months", pos: "CLAUSE", type: "grammar_structure", lemma: null,
          ...
          expl: "Past Perfect Continuous + sıfır relative pronoun: 'he had been carrying' tanımsız gerginliği süregelmiş eylemle niteler.",
        ...
        { surface: "in an instant", pos: "ADV", type: "idiom", lemma: null,
          tr: "bir anda / anında",
          expl: "'in an instant' = çok kısa sürede, saniyeler içinde. Etkinin hızını vurgular.",
        ...
        { surface: "without bringing up", pos: "VERB", type: "grammar_structure", lemma: "bring up",
          ...
          expl: "'without + gerund' + 'bring up' phrasal verb: bir konuyu ortaya atmadan, o konuya değmeden.",
        ...
        { surface: "had stayed away", pos: "VERB", type: "phrasal_verb", lemma: "stay away",
          ...
          expl: "'stay away' = bir yerden ya da kişiden kasıtlı olarak uzak durmak. Past Perfect yapısında.",
        ...
        { surface: "from now on", pos: "ADV", type: "idiom", lemma: null,
          ...
          expl: "'from now on' = bu andan itibaren sürekli olarak; bir kararı gelecekte uygulamaya koyma niyeti.",
    ...
    get annotations() {
      return ann(this._text, [
        { surface: "had been hanging in the window", pos: "VERB", type: "grammar_structure", lemma: "hang",
          ...
          expl: "Past Perfect Continuous: önceki bir andan üç hafta boyunca süregelen durum. Sürekliliği vurgular.",
        ...
        { surface: "had not told anyone in advance", pos: "VERB", type: "grammar_structure", lemma: "tell",
          ...
          expl: "Past Perfect olumsuz: bildirim anından önce gerçekleşmemiş eylem. 'in advance' = önceden.",
        ...
        { surface: "had found out by arriving at work", pos: "VERB", type: "grammar_structure", lemma: "find out",
          ...
          expl: "'find out' = bir şeyi keşfetmek. 'by + gerund' yöntemi gösterir. Past Perfect: öğrenme daha önce gerçekleşti.",
        ...
        { surface: "set foot in", pos: "VERB", type: "idiom", lemma: "set foot in",
          ...
          expl: "Deyim. 'set foot in' = bir yere girmek ya da gitmek. Çoğunlukla olumsuz veya özel durumlarda kullanılır.",
        ...
        { surface: "browsing the shelves", pos: "VERB", type: "collocation", lemma: "browse",
          ...
          expl: "'browse' = hedef belirtmeksizin dolaşarak bakmak. Kitabevi, mağaza için yaygın.",
        ...
        { surface: "about to disappear", pos: "VERB", type: "grammar_structure", lemma: "be about to",
          ...
          expl: "'be about to' = çok yakın gelecekte gerçekleşmesi beklenen eylem. Burada sona erme tehdidi.",
        ...
        { surface: "had been coming in every Saturday for decades", pos: "VERB", type: "grammar_structure", lemma: "come in",
          ...
          expl: "Past Perfect Continuous: geçmişte uzun süre tekrar eden alışkanlık. 'for decades' süreyi pekiştirir.",
        ...
        { surface: "whose late husband had proposed to her", pos: "CLAUSE", type: "relative_clause", lemma: null,
          ...
          expl: "'whose' sahiplik bildiren relative pronoun. 'late husband' = merhum koca. Past Perfect anı ifade eder.",
        ...
        { surface: "outlast him", pos: "VERB", type: "word", lemma: "outlast",
          ...
          expl: "'outlast' = bir şeyin ya da kişinin daha uzun süre ayakta kalması. 'out-' öneki 'daha fazla' anlamı katar.",
        ...
        { surface: "not entirely sorry", pos: "ADJ", type: "grammar_structure", lemma: null,
          ...
          expl: "Litotes (zayıflatılmış olumsuz): 'not entirely sorry' = tamamen üzgün değil ama tam da mutlu sayılmaz. Karmaşık duyguyu ima eder.",
    ...
    get annotations() {
      return ann(this._text, [
        ...
        { surface: "had reacted more strongly than she had intended to", pos: "VERB", type: "grammar_structure", lemma: null,
          ...
          expl: "Past Perfect karşılaştırma: iki Past Perfect eylem kıyaslanıyor. 'more strongly than intended' gerçek tepki ile niyet arasındaki farkı gösterir.",
        ...
        { surface: "had hardened between them", pos: "VERB", type: "word", lemma: "harden",
          ...
          expl: "'harden' = bir şeyin sertleşmesi, esnekliğini yitirmesi. Burada aralarındaki duvarın kalıplaştığını anlatır.",
        ...
        { surface: "side by side", pos: "ADV", type: "idiom", lemma: null,
          tr: "yan yana",
          expl: "Deyimsel zarf. İki kişinin fiziksel olarak yanyana bulunması; bazen birlikte çalışma anlamında da kullanılır.",
        ...
        { surface: "I should have called", pos: "VERB", type: "grammar_structure", lemma: null,
          tr: "aramalıydım / aramalıydım ama aramadım",
        ...
        { surface: "had been rehearsing responses", pos: "VERB", type: "grammar_structure", lemma: "rehearse",
          ...
          expl: "Past Perfect Continuous: o ana kadar süregelen zihinsel hazırlık. 'rehearse' = prova yapmak, zihinde tekrar etmek.",
        ...
        { surface: "at last", pos: "ADV", type: "idiom", lemma: null,
          tr: "sonunda / nihayet",
          expl: "'at last' = uzun bir bekleme ya da mücadelenin ardından sonunda. Rahatlama ya da çözüm hissi içerir.",
    ...
    get annotations() {
      return ann(this._text, [
        { surface: "had barely turned the corner before", pos: "VERB", type: "grammar_structure", lemma: null,
          ...
          expl: "'had barely ... before' = bir eylem bitmeden hemen başka bir şeyin gerçekleşmesi. Çok kısa zaman dilimini vurgular.",
        ...
        { surface: "had made the right choice", pos: "VERB", type: "grammar_structure", lemma: "make",
          ...
          expl: "Past Perfect: merak etme anından daha önce gerçekleşen karar. 'the right choice' = doğru seçim kalıbı.",
        ...
        { surface: "in person", pos: "ADV", type: "prepositional_phrase", lemma: null,
          ...
          expl: "'in person' = fiilen, gerçekte orada bulunarak. Çevrimiçi ya da fotoğrafla değil, doğrudan.",
        ...
        { surface: "signing the lease", pos: "VERB", type: "collocation", lemma: "sign the lease",
          ...
          expl: "'sign the lease' = kira kontratına imza atmak. Kiralık daire sürecinde standart ifade.",
        ...
        { surface: "starting over", pos: "VERB", type: "phrasal_verb", lemma: "start over",
          ...
          expl: "'start over' = her şeyi bırakıp yeni bir sayfa açmak. Özellikle zorlu bir dönemin ardından kullanılır.",
        ...
        { surface: "not entirely unfamiliar", pos: "ADJ", type: "grammar_structure", lemma: null,
          ...
          expl: "Litotes: 'not entirely unfamiliar' = biraz tanıdık ama tam da bildik sayılmaz. Çift olumsuzla yumuşatılmış ifade.",
        ...
        { surface: "passed in a blur of small logistics", pos: "VERB", type: "idiom", lemma: null,
          ...
          expl: "'in a blur' = bulanık, hızla, net hatıraları kalmayacak biçimde. 'small logistics' = ev kurmanın küçük ayrıntıları.",
